...
public class AttesterSlashingPhase1
    implements Merkleizable, SimpleOffsetSerializable, SSZContainer {

  // The number of SimpleSerialize basic types in this SSZ Container/POJO.
  public static final int SSZ_FIELD_COUNT = 2;

  private final IndexedAttestationPhase1 attestation_1;
  private final IndexedAttestationPhase1 attestation_2;

  public AttesterSlashingPhase1(
      IndexedAttestationPhase1 attestation_1, IndexedAttestationPhase1 attestation_2) {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof AttesterSlashingPhase1)) {
      return false;
    }

    AttesterSlashingPhase1 other = (AttesterSlashingPhase1) obj;
  ...
  /** ******************* * GETTERS & SETTERS * * ******************* */
  public IndexedAttestationPhase1 getAttestation_1() {
    return attestation_1;
  }

  public IndexedAttestationPhase1 getAttestation_2() {
