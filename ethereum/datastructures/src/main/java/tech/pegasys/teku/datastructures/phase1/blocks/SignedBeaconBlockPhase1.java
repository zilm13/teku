...
package tech.pegasys.teku.datastructures.phase1.blocks;
...
public class SignedBeaconBlockPhase1
    implements SimpleOffsetSerializable, SSZContainer, Merkleizable {

  private final BeaconBlockPhase1 message;
  private final BLSSignature signature;

  public SignedBeaconBlockPhase1(final BeaconBlockPhase1 message, final BLSSignature signature) {
    this.message = message;
    this.signature = signature;
  }

  public BeaconBlockPhase1 getMessage() {
    return message;
  }
  ...
  public boolean equals(final Object o) {
    ...
    final SignedBeaconBlockPhase1 that = (SignedBeaconBlockPhase1) o;
