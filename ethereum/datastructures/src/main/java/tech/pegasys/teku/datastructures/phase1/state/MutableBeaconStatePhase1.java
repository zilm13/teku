...
public interface MutableBeaconStatePhase1 extends BeaconStatePhase1, ContainerViewWriteRef {

  static MutableBeaconStatePhase1 createBuilder() {
    return MutableBeaconStatePhase1Impl.createBuilder();
  }
  ...
  @Override
  BeaconStatePhase1 commitChanges();
}
