...
public interface BeaconState extends SszContainer {
  ...
  SszField PREVIOUS_JUSTIFIED_CHECKPOINT_FIELD =
      new SszField(19, "previous_justified_checkpoint", Checkpoint.SSZ_SCHEMA);
  SszField CURRENT_JUSTIFIED_CHECKPOINT_FIELD =
      new SszField(20, "current_justified_checkpoint_field", Checkpoint.SSZ_SCHEMA);
  SszField FINALIZED_CHECKPOINT_FIELD =
      new SszField(21, "finalized_checkpoint", Checkpoint.SSZ_SCHEMA);
