...
public final class BeaconBlockPhase1
  ...
  // Body
  private BeaconBlockBodyPhase1 body;

  public BeaconBlockPhase1(
      UnsignedLong slot,
      UnsignedLong proposer_index,
      Bytes32 parent_root,
      Bytes32 state_root,
      BeaconBlockBodyPhase1 body) {
    this.slot = slot;
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof BeaconBlockPhase1)) {
      return false;
    }

    BeaconBlockPhase1 other = (BeaconBlockPhase1) obj;
  ...
  /** ******************* * GETTERS & SETTERS * * ******************* */
  public BeaconBlockBodyPhase1 getBody() {
    return body;
  }
