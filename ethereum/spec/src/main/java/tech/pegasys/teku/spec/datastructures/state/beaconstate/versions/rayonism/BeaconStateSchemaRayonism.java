...
public class BeaconStateSchemaRayonism
  ...
  public static final int WITHDRAWALS_INDEX = 22;
  ...
  private static List<SszField> getUniqueFields(final SpecConfig specConfig) {
    ...
    final SszField withdrawalsField =
        new SszField(
            WITHDRAWALS_INDEX,
            BeaconStateFields.WITHDRAWALS.name(),
            () ->
                SszListSchema.create(
                    Withdrawal.SSZ_SCHEMA, specConfig.getWithdrawalRegistryLimit()));
    return List.of(
