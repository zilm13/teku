...
public class SpecConfigBuilder {
  ...
  private void validate() {
    ...
    validateConstant("eth1AddressWithdrawalPrefix", eth1AddressWithdrawalPrefix);
    ...
    validateConstant("withdrawalRegistryLimit", withdrawalRegistryLimit);
  ...
  public SpecConfigBuilder eth1AddressWithdrawalPrefix(final Bytes eth1AddressWithdrawalPrefix) {
  ...
  public SpecConfigBuilder withdrawalRegistryLimit(final Long withdrawalRegistryLimit) {
