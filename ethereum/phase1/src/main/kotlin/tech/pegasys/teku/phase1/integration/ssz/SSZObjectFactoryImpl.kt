...
class SSZObjectFactoryImpl : SSZObjectFactory {
  ...
  override fun <T : Any> SSZList(immutable: SSZList<T>): SSZMutableList<T> =
    SSZMutableListWrapper<T, Any>(immutable)
  ...
  override fun <T : Any> SSZVector(immutable: SSZVector<T>): SSZMutableVector<T> =
    SSZMutableVectorWrapper<T, Any>(immutable)
