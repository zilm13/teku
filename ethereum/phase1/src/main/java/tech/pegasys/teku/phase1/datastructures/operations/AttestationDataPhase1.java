...
public class AttestationDataPhase1 extends AbstractImmutableContainer
    implements SimpleOffsetSerializable, Merkleizable, SSZContainer {

  // The number of SimpleSerialize basic types in this SSZ Container/POJO.
  public static final int SSZ_FIELD_COUNT = 5;

  public static final ContainerViewType<AttestationDataPhase1> TYPE =
  ...
  private AttestationDataPhase1(
      ContainerViewType<AttestationDataPhase1> type, TreeNode backingNode) {
    super(type, backingNode);
  }

  public AttestationDataPhase1(
      UnsignedLong slot,
      UnsignedLong index,
