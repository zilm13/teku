...
public class SszPrimitives {
  ...
  public static class SszUInt256 extends AbstractSszPrimitive<UInt256, SszUInt256> {

    public static SszUInt256 fromBI(BigInteger val) {
      return new SszUInt256(UInt256.valueOf(val));
    }

    public static SszUInt256 fromLong(long val) {
      return new SszUInt256(UInt256.valueOf(val));
    }

    public SszUInt256(UInt256 val) {
